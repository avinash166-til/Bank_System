...
function fetchTransactionData1() {

	const accountAmount = localStorage.getItem("AMOUNT");

	callTransactionDataAPI1(accountAmount);

}

async function callTransactionDataAPI1(accountAmount) {

	const url = BASE_URL + '/transaction/' + accountAmount;
	...
	fillStatementTable1(allTransactions)

	console.log(allTransactions);
}

function fillStatementTable1(allTransactions) {
